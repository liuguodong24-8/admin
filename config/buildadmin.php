...
return [
    // 允许跨域访问的域名
    'cors_request_domain'   => 'localhost,127.0.0.1,test.hellocrab.top,sccd.hellocrab.top,zxtapi.paix.com.cn,132.232.108.101:8082,sosmap.hellocrab.top',
    // 是否开启管理员登录验证码
    ...
    'token'                 => [
        ...
        'default' => 'mysql',
        // 加密key
        'key'     => 'Rgst4JA3HCElMa9nvXoZPu0bSIFU2QcG',
        // 加密方式
        'algo'    => 'ripemd160',
        // 驱动
        'stores'  => [
